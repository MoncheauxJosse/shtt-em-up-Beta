...
public class MeteoriteGlace extends MeteoriteAbstract{
	...
	private static final int SCORE_VAL = 3;
	...
	public MeteoriteGlace(JPanel p, Meteorite m, Avion pl) {
		super(p, m, pl);
	}
	
	@Override
	public String toString() {
		return "MeteoriteGlace";
	}
